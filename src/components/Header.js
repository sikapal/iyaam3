    ...
    {/*
       ...
       <header className="header-top-strip py-3">
        <div className='.container-xxl'>
          <div className='row'>
            <div className='col-6'>
              <p className='text-white mb-0'> Trouvez tout ce dont vous cherchez </p>
            </div>

            <div className='col-6'>
              <p className='text-end text-white mb-0'>
                Contactez-nous :
                <a className='text-white' href='tel: (237) 690178647 '>(237) 693178647 </a></p>
            </div>
      ...
      <header className='header-upper py-3'>
        ...
        <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h1>
                <Link className='text-white'> Iyaam</Link>
              </h1>
            </div>
            <div className='col-5'>
            ...
            <div className='col-5'>
              <div className='header-upper-links d-flex align-items-center justify-content-between'>
               ...
               < FaCodeCompare />
                ...
                <div>
                  <Link className='d-flex align-items-center gap-10 text-white' to="/wishlists">
                  <FaRegBookmark /> 
